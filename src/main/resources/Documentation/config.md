...
:	Use stream events to trigger pull-replication actions alongside the
	...
	instead of [replication.instanceLabel](https://github.com/GerritForge/pull-replication/blob/master/src/main/resources/Documentation/config.md) must be used.
...
:	Topic to consumer stream events from.
	...
	instead of [replication.instanceLabel](https://github.com/GerritForge/pull-replication/blob/master/src/main/resources/Documentation/config.md)
	must be used.
