...
/**
 * Batches ref-updates that each carry more than one object (e.g. a whole meta-ref objects'
 * ancestry), applying every ref's revisions as a single ref-update, via {@link ApplyObjectsAction}.
 */
@Singleton
