...
public class FetchRestApiClient implements FetchApiClient, ResponseHandler<HttpResult> {
  ...
  /* (non-Javadoc)
   * @see com.gerritforge.gerrit.plugins.replication.pull.client.FetchApiClient#initProject(com.google.gerrit.entities.Project.NameKey, org.eclipse.jgit.transport.URIish, long, java.util.List<com.gerritforge.gerrit.plugins.replication.pull.api.data.RevisionData>)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.gerritforge.gerrit.plugins.replication.pull.client.FetchApiClient#deleteProject(com.google.gerrit.entities.Project.NameKey, org.eclipse.jgit.transport.URIish)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.gerritforge.gerrit.plugins.replication.pull.client.FetchApiClient#updateHead(com.google.gerrit.entities.Project.NameKey, java.lang.String, org.eclipse.jgit.transport.URIish)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.gerritforge.gerrit.plugins.replication.pull.client.FetchApiClient#callSendObject(com.google.gerrit.entities.Project.NameKey, java.lang.String, boolean, com.gerritforge.gerrit.plugins.replication.pull.api.data.RevisionData, org.eclipse.jgit.transport.URIish)
   */
  @Override
  ...
  public HttpResult callSendObjects(
    ...
    RevisionsInput input =
        new RevisionsInput(instanceId, refName, eventCreatedOn, revisionData.toArray(inputData), source.getStoreReflog());
